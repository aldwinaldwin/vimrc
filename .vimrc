...
set pastetoggle=<F2>
set nopaste  " using vim-bracketed-paste now, no need start with paste
...
" Code from: https://github.com/ConradIrwin/vim-bracketed-paste
